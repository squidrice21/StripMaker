...
public:
  ...
  Capture cut_spirals(Capture const &capture,
                      std::map<size_t, size_t> &cutindex_to_index,
                      std::map<size_t, std::vector<size_t>> &c_record) const;
  std::vector<Sketch> cut_evenly(std::vector<Sketch> const &strokes,
  ...
  Capture cut_cornucopia(Capture const &capture,
                         std::map<size_t, size_t> &cutindex_to_index,
                         std::map<size_t, std::vector<size_t>> &c_record,
                         bool output_orig = false);
