...
#ifdef SINGLE
/* Used to split REAL factors for exact multiplication. */
const static REAL splitter = 4097.0f;
/* Floating-point machine epsilon. */
#define TRI_EPSILON (0.5f * FLT_EPSILON)
#else /* SINGLE */
const static REAL splitter = 134217729.0;
#define TRI_EPSILON (0.5 * DBL_EPSILON)
#endif /* SINGLE */

const static REAL resulterrbound = (3.0 + 8.0 * TRI_EPSILON) * TRI_EPSILON;
const static REAL ccwerrboundA = (3.0 + 16.0 * TRI_EPSILON) * TRI_EPSILON;
const static REAL ccwerrboundB = (2.0 + 12.0 * TRI_EPSILON) * TRI_EPSILON;
const static REAL ccwerrboundC = (9.0 + 64.0 * TRI_EPSILON) * TRI_EPSILON * TRI_EPSILON;
const static REAL iccerrboundA = (10.0 + 96.0 * TRI_EPSILON) * TRI_EPSILON;
const static REAL iccerrboundB = (4.0 + 48.0 * TRI_EPSILON) * TRI_EPSILON;
const static REAL iccerrboundC = (44.0 + 576.0 * TRI_EPSILON) * TRI_EPSILON * TRI_EPSILON;
const static REAL o3derrboundA = (7.0 + 56.0 * TRI_EPSILON) * TRI_EPSILON;
const static REAL o3derrboundB = (3.0 + 28.0 * TRI_EPSILON) * TRI_EPSILON;
const static REAL o3derrboundC = (26.0 + 288.0 * TRI_EPSILON) * TRI_EPSILON * TRI_EPSILON;
#undef TRI_EPSILON
