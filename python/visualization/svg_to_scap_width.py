...
from transfer_scap import scale_capture
import scapio
...
def parse_path(paths, attributes, sample_rate_mm):
    ...
    return resampled_paths, thickness_arr, name_map
...
if __name__ == '__main__':
    ...
    resampled_paths, thickness_arr, name_map = parse_path(
